        ...
        new Thread() {
            ...
            public void run() {
                try {
                    ...
                    System.out.println("Cliente ok e em contato com servidor...");
                    ...
                    while (true) {
                        ...
                        if (btn.getName().equals("ball")){
                            jButtonBall.setLocation(btn.getX(), btn.getY());
                        }else{
                            jButtonPlayer1.setLocation(btn.getX(), btn.getY());
                        }
                        
                        escritor.flush();
                        escritor.writeObject(jButtonPlayer2);
                    }
                } catch (Exception e) {
